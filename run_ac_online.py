...
if __name__ == '__main__':
    ...
    cfg.policy_fn_config = format_path.fill_run_number(cfg.policy_fn_config, cfg.run, cfg.param_setting, cfg.data_root)
    cfg.critic_fn_config = format_path.fill_run_number(cfg.critic_fn_config, cfg.run, cfg.param_setting, cfg.data_root)
    ...
    if hasattr(cfg, 'secn_weight_config'):
        cfg.secn_weight_config = format_path.fill_run_number(cfg.secn_weight_config, cfg.run, cfg.param_setting, cfg.data_root)
