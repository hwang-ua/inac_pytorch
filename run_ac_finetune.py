...
if __name__ == '__main__':
    ...
    cfg.policy_fn_config = fill_run_number(cfg.policy_fn_config, cfg.run, cfg.param_setting, cfg.data_root)
    cfg.critic_fn_config = fill_run_number(cfg.critic_fn_config, cfg.run, cfg.param_setting, cfg.data_root)
    cfg.val_fn_config = fill_run_number(cfg.val_fn_config, cfg.run, cfg.param_setting, cfg.data_root)
